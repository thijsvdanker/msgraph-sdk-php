    ...
    */
    public function getRestrictPeerSelectionBy()
    {
        if (array_key_exists("restrictPeerSelectionBy", $this->_propDict)) {
            if (is_a($this->_propDict["restrictPeerSelectionBy"], "Microsoft\Graph\Beta\Model\DeliveryOptimizationRestrictPeerSelectionByOptions")) {
    ...
    */
    public function getGroupIdSource()
    {
        if (array_key_exists("groupIdSource", $this->_propDict)) {
            if (is_a($this->_propDict["groupIdSource"], "Microsoft\Graph\Beta\Model\DeliveryOptimizationGroupIdSource")) {
    ...
    */
    public function getBandwidthMode()
    {
        if (array_key_exists("bandwidthMode", $this->_propDict)) {
            if (is_a($this->_propDict["bandwidthMode"], "Microsoft\Graph\Beta\Model\DeliveryOptimizationBandwidth")) {
    ...
    */
    public function getMaximumCacheSize()
    {
        if (array_key_exists("maximumCacheSize", $this->_propDict)) {
            if (is_a($this->_propDict["maximumCacheSize"], "Microsoft\Graph\Beta\Model\DeliveryOptimizationMaxCacheSize")) {
    ...
    */
    public function getVpnPeerCaching()
    {
        if (array_key_exists("vpnPeerCaching", $this->_propDict)) {
            if (is_a($this->_propDict["vpnPeerCaching"], "Microsoft\Graph\Beta\Model\Enablement")) {
