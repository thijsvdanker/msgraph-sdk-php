    ...
    */
    public function getDeviceStateSummary()
    {
        if (array_key_exists("deviceStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStateSummary"], "Microsoft\Graph\Beta\Model\DeviceManagementIntentDeviceStateSummary")) {
    ...
    */
    public function getUserStateSummary()
    {
        if (array_key_exists("userStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["userStateSummary"], "Microsoft\Graph\Beta\Model\DeviceManagementIntentUserStateSummary")) {
